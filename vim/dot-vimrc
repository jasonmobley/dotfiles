...
" Use base16-eighties when we have a GUI (gvim, macvim) but use
" Tomorrow-Night-Eighties by default because base16 schemes don't
" look right in a terminal unless you use base16-shell too.
set background=dark
